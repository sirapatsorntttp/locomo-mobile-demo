...
export interface PlantCompany extends BaseEntity {
  plant_id: string;
  company_id: string;
  plant?: Plant;
  company?: Company;
}
export interface CompanyPlant extends BaseEntity {
  company_id: string;
  plant_id: string;
  company?: Company;
  plants?: Plant;
}
export interface CompanyPlantEmployee extends BaseEntity {
...
export interface ZoneRoute extends BaseEntity {
  zone_id: string;
  route_id: string;
  zone?: Zone;
  route?: Route;
}
export interface PlantCompanyZone extends BaseEntity {
  plant_company_id: string;
  zone_id: string;
  plant_company?: PlantCompany;
  zone?: Zone;
}
...
export interface DriverVehicleVendor extends BaseEntity {
  driver_vehicle_id: string;
  vendor_id: string;
  driver_vehicle?: DriverVehicle;
  vendor?: Vendor;
}
export interface CompanyVendor extends BaseEntity {
  company_id: string;
  vendor_id: string;
  company?: Company;
  vendor?: Vendor;
}
export interface PlantVendorService extends BaseEntity {
  plant_id: string;
  vendor_id: string;
  plant?: Plant;
  vendor?: Vendor;
...
// COORDINATORS
// ============================================================
export interface CoordinatorType extends BaseEntity {
  name_th: string;
  name_en: string;
}
...
export interface Post extends BaseEntity {
  ...
  shift_id: string;
  shift?: Shift;
  driver_vehicle_vendor_id: string;
  driver_vehicle_vendor?: DriverVehicleVendor;
}
...
export interface Reserve extends BaseEntity {
  ...
  route_id: string;
  route?: Route;
  plant_company_zone_id: string;
  plant_company_zone?: PlantCompanyZone;
  working_date?: string;
  travel_date: string;
...
// CALENDAR
// ============================================================
export interface CalendarGroup extends BaseEntity {
  plant_company_id: string;
  name: string;
  color: string;
...
export interface Notification extends BaseEntity {
  plant_company_employee_id: string;
  title: string | null;
  detail: string | null;
  image: string;
...
export interface ImageComment extends BaseEntity {
  comment_id: string;
  image: string;
}
export interface Feedback extends BaseEntity {
  employee_id: string;
  comment_id: string;
  feedback_commant: string | null;
  employee?: Employee;
  images?: ImageFeedback[];
}
export interface ImageFeedback extends BaseEntity {
  feedback_id: string;
  image: string;
}
...
// LOGS
// ============================================================
export interface ActionDataLog {
  id: string;
  action: ActionType;
  table_name: string;
  module_id: string;
...
export interface DeleteDataLog {
  id: string;
  delete: DeleteType;
  table_name: string;
  module_id: string;
...
export interface ActionDriverLog {
  id: string;
  driver_id: string;
  event: DriverEvent;
  time_log: string;
...
export interface ActionDriverLateLog {
  id: string;
  post_id: string;
  time_log: string;
  remark: string | null;
...
export interface DailyVehicleStat {
  date: string;
  total: number;
...
export interface AppNotification {
  id: string;
  company_plant_employee_id: string;
  title: string | null;
  detail: string | null;
  type: string;
  is_status: string; // 'unread' | 'read'
  created_at: string;
  companys_plants_employees?: {
    id: string;
    employee_id: string;
